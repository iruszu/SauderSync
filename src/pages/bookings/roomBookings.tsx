...
export default function Rooms() {
  ...
  const handleTimeSlotMouseEnter = (
    ...
    if (!isSelecting || !dragStart || dragStart.roomIndex !== roomIndex || !isAvailable)
      return;
  ...
  const handleBookRoom = async () => {
    if (
      ...
      selectedTimeSlots.slots.length === 0 ||
      !selectedDate
    )
      return;
                  ...
                  <Box style={{ width: '100%' }}>
                    ...
                    >
                      {timeSlots.map((time, timeIndex) => {
                        ...
                        const isSelected =
                          selectedTimeSlots.roomIndex === index &&
                          selectedTimeSlots.slots.includes(timeIndex);
                        ...
                        return (
                          <Box key={timeIndex} style={{ textAlign: 'left' }}>
                            ...
                            <Box
                              ...
                              onMouseDown={() =>
                                handleTimeSlotMouseDown(index, timeIndex, isAvailable)
                              }
                              onMouseEnter={() =>
                                handleTimeSlotMouseEnter(index, timeIndex, isAvailable)
                              }
                            />
                          </Box>
                        );
                ...
                return (
                  <Box
                    ...
                    style={{
                      flex: 1,
                      borderRight:
                        index < 6 ? '1px solid var(--mantine-color-gray-3)' : 'none',
                    }}
                  >
                    <Center
                      p="xs"
                  ...
                  return (
                    <Box
                      ...
                      style={{
                        flex: 1,
                        borderRight:
                          dayIndex < 6 ? '1px solid var(--mantine-color-gray-3)' : 'none',
                        position: 'relative',
                        padding: 2,
                      }}
                    >
